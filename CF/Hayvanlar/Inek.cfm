    ...
    <div class="row" >
        ...
        <div align="right" class="col-md-3">
            <cfimage name ="tavukresim" 
                action="writeToBrowser" 
                source="D:\cabri\workcube\Odev_Ciftlik\img\inek_ayna.png" 
...
<!--- HayvanCesidi]
      ...
      <cfquery name="HayvanSayi" datasource="Ciftlik">
        ...
        FROM 
        HayvanDetay
        WHERE HayvanCesidi = 'İnek'
        GROUP BY HayvanCesidi, HayvanTuru
    </cfquery>
    <!--İnek Sayılarını gösteren tablo -->
    <div class="container p-3 my-3 col-md-6">
        <span>
            <table widht="99%">
                <td align="left" height="40"><h4>İnek Sayım Bilgileri</h4></td>
        </table>
    ...
    <div class="container p-3 my-3 col-md-6">
        <span>
            <table widht="99%">
                <td align="left" height="40"><h4>İnek Cinsiyet Bilgileri</h4></td>
        </table>
        <table class="table table-bordered table-sm small" border="1" bordercolor="#99999" width="99%" align="center">
            <tr>
                <td><b>No</b></td>
    ...
    <div class="row">
        ...
        <div class="container p-3 my-3 col-md-3 ">
            <table align="left" widht="99%">
                <tr>
                    <td height="40" align="left"><h4>Yeni İnek Ekleme</h4></td>
                </tr>
            </table>
        ...
        <div class="container p-3 my-3 col-md-8">
            <span>
                <table widht="99%">
                    <td align="left" height="40"><h4>Genel İnek Bilgileri</h4></td>
            </table>
            <table class="table table-bordered table-sm small" border="1" bordercolor="#99999" width="99%" align="center">
                <tr>
                    <td><b>No</b></td>
...
<div class="container-fluid" >
    <div class="row">
        ...
        <div class="container p-3 my-3 col-md-3 ">
            <table align="left" widht="99%">
                <tr>
                    <td height="40" align="left"><h4>Gebe İnekler</h4></td>
                </tr>
            </table>
        ...
        <!--SQL sorgu alanı yalnızca gebe tavukları çekiyor -->
            <cfquery name="HayvanDetay" datasource="Ciftlik">
                ...
                FROM 
                HayvanDetay
                WHERE HayvanCesidi = 'İnek' AND GebelikDurumu = 'Gebe'
            </cfquery>
            <br><br><br>

        <!--GEBE İnek gösteren tablo -->
        <div class="container p-3 my-3 col-md-5">
            <span>
                <table widht="99%">
                    <td align="left" height="40"><h4>Gebelik Dönemindeki İnek Bilgileri</h4></td>
                </table>
...
<div class="container-fluid" >
    <div class="row">
        ...
        <div class="container p-3 my-3 col-md-3 ">
            <table align="left" widht="99%">
                <tr>
                    <td height="40" align="left"><h4>Yetişkin Buzağı Güncelleme</h4></td>
                </tr>
            </table>
    ...
    <cfquery name="HayvanDetay" datasource="Ciftlik">
        ...
        FROM 
        HayvanDetay
        WHERE HayvanCesidi = 'İnek' AND YavrulukDurumu = 'Yavru'
    </cfquery>
    <br><br><br>

    <!--Yavru İnek gösteren tablo -->
    <div class="container p-3 my-3 col-md-5">
        <span>
            <table widht="99%">
                <td align="left" height="40"><h4>Buzağı Bilgileri</h4></td>
            </table>
            <table name="gebelik" class="table table-bordered table-sm small" border="1" bordercolor="#99999" width="99%" align="center">
                <tr>
                    <td><b>No</b></td>

    ...
    <div class="row" >
        ...
        <div align="right" class="col-md-3">
            <cfimage name ="kopekresim" 
                action="writeToBrowser" 
                source="D:\cabri\workcube\Odev_Ciftlik\img\kopek_ikon.png" 
...
<!--- HayvanCesidi]
      ...
      <cfquery name="HayvanSayi" datasource="Ciftlik">
        ...
        FROM 
        HayvanDetay
        WHERE HayvanCesidi = 'Kopek'
        GROUP BY HayvanCesidi, HayvanTuru
    </cfquery>
    <!--Kopek Sayılarını gösteren tablo -->
    <div class="container p-3 my-3 col-md-6">
        <span>
            <table widht="99%">
                <td align="left" height="40"><h4>Köpek Sayım Bilgileri</h4></td>
        </table>
    ...
    <div class="container p-3 my-3 col-md-6">
        <span>
            <table widht="99%">
                <td align="left" height="40"><h4>Kopek Cinsiyet Bilgileri</h4></td>
        </table>
        <table class="table table-bordered table-sm small" border="1" bordercolor="#99999" width="99%" align="center">
            <tr>
                <td><b>No</b></td>
    ...
    <div class="row">
        ...
        <div class="container p-3 my-3 col-md-3 ">
            <table align="left" widht="99%">
                <tr>
                    <td height="40" align="left"><h4>Yeni Kopek Ekleme</h4></td>
                </tr>
            </table>
            <cfform name="YeniHayvanEkleme" action="..\CFC\addGenelHayvan.cfc?method=addYeniHayvan" method="post" >
                ...
                <tr>
                    <td>Mahsul</td>
                    <td>: <cfinput type="text" name="Mahsul" maxlength="50" required="true" value="Yok"></td>
                </tr>
                <tr>
                    <td>Kayit Tarihi</td>
        ...
        <!--SQL sorgu alanı yalnızca kopekları çekiyor -->
        ...
        <!--kopekları gösteren tablo -->
        <div class="container p-3 my-3 col-md-8">
            <span>
                <table widht="99%">
                    <td align="left" height="40"><h4>Genel Kopek Bilgileri</h4></td>
            </table>
            <table class="table table-bordered table-sm small" border="1" bordercolor="#99999" width="99%" align="center">
                <tr>
                    <td><b>No</b></td>

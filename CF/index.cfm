...
<div class="row">
    ...
    <div name="excel-veri-aktarimi" class="p-2 m-2 col-md-2">
        ...
        <cfform method="post"  enctype="multipart/form-data" action="excel_upload.cfm">
    ...
    <div name="genel" class="container d-flex justify-content-center">
        <div class="row text-center">
            ...
            <div name="excel" class=" p-3 m-3 col-sm-2 " onclick="document.location='excel_aktarma.cfm'">
                <h3>Excell import</h3>
                <cfimage name ="isresim" 
                        action="writeToBrowser" 
                        source="..\img\excel.png" 
            ...
            <div name="excel-veri-aktarimi" class="p-2 m-2 col-md-2">
                ...
                <cfparam name="form.file_11" default="">
                <cfparam name="form.FileName" default="">
                <cfparam name="form.is_submitted" default="">

                <cfif structKeyExists(form, "file_11")>
                    <cfobject component="excel" name="ExcellEkleme">
                </cfif>
